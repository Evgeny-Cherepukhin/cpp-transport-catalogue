...
// Дмитрий! 
// Большое спасибо за быструю проверку. Прошу прощения за мою невнимательность,
// старался всё учесть и допустил досадную ошибку. В дальнейшем буду стараться не забывать 
// все объявления библиотек делать h-файлах.
//		Я не волшебник, а только учусь. Благодаря Вам и Вашим коллегам такие студента
// как я начинают программировать практически с нуля, не имея большого опыта.
